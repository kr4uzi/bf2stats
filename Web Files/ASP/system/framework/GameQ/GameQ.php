...
class GameQ
{
     ...
     * @type string
     */
    protected $queryLibrary = Native::class;
     ...
     * @return $this
     */
    public function setOption($var, $value): static
    {
     ...
     * @return $this
     */
    public function addServer(array $server_info = []): static
    {
     ...
     * @throws Exception
     */
    public function addServersFromFiles($files = []): static
    {
     ...
     * @return $this
     */
    public function clearServers(): static
    {
     ...
     * @return $this
     */
    public function addFilter($filterName, $options = []): static
    {
     ...
     * @return $this
     */
    public function removeFilter($filterHash): static
    {
        // Make lower case
    ...
    protected function doApplyFilters(array $results, Server $server)
    {
        ...
        foreach ($this->options['filters'] as $filterOptions) {
            ...
            try {
                ...
                $class = new ReflectionClass(sprintf('GameQ\\Filters\\%s', ucfirst((string) $filterOptions['filter'])));
